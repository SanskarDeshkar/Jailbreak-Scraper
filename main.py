"""Entry point for scraping and parsing Jailbreak item values."""
...
def main() -> None:
    ...
    if html_content is None:
        print("Failed to fetch page HTML. No item nodes parsed.")
        return
    ...
    print(f"Successfully filtered and parsed {len(vehicles)} item nodes.")
